...
import (
	...
	"github.com/n-kisyov/gclock/internal/audio"
	"github.com/n-kisyov/gclock/internal/settings"
	"github.com/n-kisyov/gclock/internal/ui"
)
...
func wndProc(hwnd win.HWND, msg uint32, wParam, lParam uintptr) uintptr {
	...
	case win.WM_PAINT:
		...
		// Draw Clock
		if gState.Settings.ClockStyle == settings.ClockAnalog {
